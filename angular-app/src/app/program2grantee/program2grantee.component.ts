...
@Component({
  selector: 'app-program2grantee',
  templateUrl: './program2grantee.component.html',
  styleUrls: ['./program2grantee.component.css'],
  providers: [program2granteeService]
})
export class program2granteeComponent implements OnInit {
  ...
  constructor(private serviceprogram2grantee: program2granteeService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceprogram2grantee.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'com.usgov.ed.grants.program2grantee',
    ...
    return this.serviceprogram2grantee.addParticipant(this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceprogram2grantee.updateParticipant(form.get('granteeId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceprogram2grantee.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceprogram2grantee.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
